...
$ketQuaDangKy = KetQuaDangKy::where('id_sv',$idUser)->orderByDesc('id_dot_dang_ky')->first();
if (!empty($ketQuaDangKy)) {
    $dotDangKy = DotDangKy::where('id', $ketQuaDangKy->id_dot_dang_ky)->first();
